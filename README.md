...
5. Become familiar with the main project and sub-projects, start with the [documentation](https://neutralino.js.org/docs), and then, with primary[codebases](https://github.com/neutralinojs).
...
8. Tell us about tasks that you would like to work on. If you have new ideas, mention them in community channels with your project goals.
...
2. Select a project idea from the ones mentioned below
3. If you have an idea of your own / want to initiate one, post its summary and goals in a [new GitHub discussion thread](https://github.com/neutralinojs/gsoc2026/discussions/new?category=ideas).
4. Wait until project maintainers give feedback on the post (We can identify possible changes in the early stage).
...
<a href="https://github.com/neutralinojs/gsoc2026/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=neutralinojs/gsoc2026" />
</a>
